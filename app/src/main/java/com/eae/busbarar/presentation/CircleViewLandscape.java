...
public class CircleViewLandscape extends View {

    private static final String TAG = "CircleView";
    private Paint srcPaint;

    public CircleViewLandscape(Context context) {
        this(context, null, 0);
    }

    public CircleViewLandscape(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CircleViewLandscape(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int ratioConstraint = getWidth()/70;
