...
object Constants {
    ...
    const val BASE_URL_ALERT_SCREEN = "http://10.45.50.32/alertwebview"
    const val BASE_URL_LIVE_DATA = "http://10.45.50.32/livedata"
    //const val BASE_URL_LIVE_DATA = "https://www.youtube.com"
